...
KipuBank es un contrato inteligente en Solidity que permite a cada usuario tener su propia bóveda de ETH. 
...
Este proyecto es la base para seguir construyendo en los próximos módulos. Está hecho con lo aprendido hasta ahora, sin librerías externas ni herramientas avanzadas. Todo el código está en `/contracts/KipuBank.sol` y se puede revisar, probar y extender fácilmente.
